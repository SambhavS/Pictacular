...
The time complexity for this naive algorithm would be O(N*M*P). N would likely be around 3000, M is around 10,000 and P would be around 1,000,000. This means that to produce one image would take *30 trillion calculations*. Clearly this is too slow & we need a better solution. 
